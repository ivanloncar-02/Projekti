...
let DashboardController = class DashboardController {
    ...
    async getMyDashboard(role, studentId, companyId, userId) {
        switch (role) {
            case user_role_enum_1.UserRole.STUDENT:
                return this.dashboardService.getStudentDashboard(studentId);
            case user_role_enum_1.UserRole.EMPLOYER:
                return this.dashboardService.getEmployerDashboard(companyId);
            case user_role_enum_1.UserRole.ACADEMIC_MENTOR:
            case user_role_enum_1.UserRole.COMPANY_MENTOR:
