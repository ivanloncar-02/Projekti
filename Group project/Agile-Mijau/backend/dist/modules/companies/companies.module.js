...
exports.CompaniesModule = CompaniesModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [companies_controller_1.CompaniesController, companies_controller_1.AdminCompaniesController],
        providers: [companies_service_1.CompaniesService],
        exports: [typeorm_1.TypeOrmModule, companies_service_1.CompaniesService],
    })
], CompaniesModule);
